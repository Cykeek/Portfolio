...
export default function Card({ children, className = '', onClick }: CardProps) {
  return (
    <motion.div 
      ...
      whileHover="hover"
      className={`group relative flex flex-col bg-white/[0.02] backdrop-blur-md border border-white/5 rounded-sm overflow-hidden transition-all duration-500 hover:bg-white/[0.04] hover:border-white/10 ${className}`}
    >
